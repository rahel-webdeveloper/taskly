...
export const askDialogDiv = () => {
  return `
  <dialog class="delete-ask-div" id="ask_delete_tasks-dialog">
    <span id="exclamation-icon"><i class="bi bi-exclamation-circle-fill"></i></span>
    <h3>Deleting tasks</h3>
    <p class="ask-div-header">Are sure you want to delete all your completed tasks? <br> It will never return back!</p>
    <div class="ask-btns">
